...
packages := "extest lsfg-vk armada-splash inputplumber fex mesa mesa-android mangohud gamescope gamescope-session powerdevil networkmanager jupiter-hw-support kernel"
