...
packages := "extest lsfg-vk armada-splash armada-stick-lighting inputplumber fex mesa mesa-android mesa-x86 mangohud gamescope gamescope-session kwin powerdevil networkmanager jupiter-hw-support umtp-responder kernel"
